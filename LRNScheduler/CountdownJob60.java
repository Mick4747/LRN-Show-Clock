 ...
 * from the Countdown class, passing in 60 as the int argument.
 * Creates and displays a 60 second countdown animation.
 */
 ...
 * @author Colin
 */
public class CountdownJob60 implements Job{
    
    public CountdownJob60() { }
    
    @Override
        public void execute(JobExecutionContext context)
            throws JobExecutionException {
            Countdowns.Countdown.runCountdown(60);  
        }
